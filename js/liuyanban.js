...
function() {
                    ...
                    return function(e) {
                        ...
                        if (e && e.nodeName && "TEXTAREA" === e.nodeName && !i.has(e)) {
                            ...
                            function() {
                                ...
                                a = "content-box" === t.boxSizing ? -(parseFloat(t.paddingTop) + parseFloat(t.paddingBottom)) : parseFloat(t.borderTopWidth) + parseFloat(t.borderBottomWidth),
                                isNaN(a) && (a = 0),
                                r()
                            } ()
                        }
    ...
    function(e, t, n) {
        ...
        r.prototype._init = function() {
            ...
            try {
                ...
                z = e.config.serverURLs || q + "avoscloud.com",
                ...
                e.placeholder = e.config.placeholder || "对火喵说点啥呀",
                e.el.innerHTML = '<div class="vwrap" style="background: #ffffffba;"><div class="vheader item' + B.length + '">' + B.join("") + '</div><div class="vedit"><textarea id="veditor" class="veditor vinput" placeholder="' + e.placeholder + '"></textarea><div class="vctrl"><span class="vemoji-btn">' + e.locale.ctrl.emoji + '</span> | <span class="vpreview-btn">' + e.locale.ctrl.preview + '</span></div><div class="vemojis" style="display:none;"></div><div class="vinput vpreview" style="display:none;"></div></div><div class="vcontrol"><div class="col col-20" title="Markdown is supported"><a href="https://segmentfault.com/markdown" target="_blank"><svg class="markdown" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z"></path></svg></a></div><div class="col col-80 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + e.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><div class="vlist"></div><div class="vempty" style="display:none;"></div><div class="vpage txt-center"></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>' + o + "</div></div>";
                var P = u.find(e.el, ".vempty");
                e.nodata = {
                    show: function(t) {
                        return P.innerHTML = t || e.locale.tips.sofa,
                        u.attr(P, "style", "display:block;"),
                        e
                    },
                    hide: function() {
                ...
                e.loading = {
                    show: function(t) {
                        ...
                        return t ? I.insertBefore(U, n[0]) : I.appendChild(U),
                        e.nodata.hide(),
                        e
                    },
                    hide: function() {
                        ...
                        return t && u.remove(t),
                        0 === u.findAll(I, ".vcard").length && e.nodata.show(),
                        e
                    }
                };
        ...
        r.prototype.installLocale = function(e, t) {
            return t = t || {},
            e && (g[e] = t, this.locale = g[e] || g["zh-cn"]),
            this
        },
        ...
        r.prototype.bind = function(e) {
            ...
            t.preview = {
                show: function() {
                    return v.comment && (t.emoji.hide(), u.attr(o, "v", 1), u.removeAttr(i, "v"), r.innerHTML = v.comment, u.attr(r, "style", "display:block"), C()),
                    t.preview
                },
                hide: function() {
            ...
            var b = function(e) {
                ...
                return u.each(n,
                function(e, t) {
                    1 === t.nodeType && (r.indexOf(t.nodeName) > -1 && ("INPUT" === t.nodeName && "checkbox" === u.attr(t, "type") ? u.attr(t, "disabled", "disabled") : u.remove(t)), "A" === t.nodeName &&
                    function(e, t) {
                        var n = u.attr(e, t);
            ...
            t.Q(y).count().then(function(e) {
                e > 0 ? (u.attr(u.find(t.el, ".vinfo"), "style", "display:block;"), u.find(t.el, ".vcount").innerHTML = '<span class="vnum">' + e + "</span> " + t.locale.tips.comments,
                function e() {
            ...
            var M = function(e, n, r) {
                ...
                s = e.get("ua") || "",
                l = "";
                s && (l = '<span style="font-size:12px;display:inline-block;line-height:20px;background: #8482eeb8;border-radius:2px;color:#fff;padding:0 5px;position:inherit;margin-right:5px;">' + (s = d(s)).browser + " " + s.version + '</span> <span style="font-size:12px;display:inline-block;line-height:20px;background: #8482eeb8;border-radius:2px;color:#fff;padding:0 5px;position:inherit;margin-right:5px;">' + s.os + " " + s.osVersion + "</span>"),
                "*" === y && (l = '<a href="' + e.get("url") + '" style="font-size:12px;display:inline-block;line-height:20px;background: #8482eeb8;border-radius:2px;color:#fff;padding:0 5px;position:inherit;margin-right:5px;">' + e.get("url") + "</a>");
                var master = e.get("mail") === "zc998800@gmail.com";
				var spanm = master ? ` <span style="font-size:12px;display:inline-block;line-height:20px;background: #ee82dcb8;border-radius:2px;color:#fff;padding:0 5px;position:inherit;margin-right:5px;" > 火喵 </span>`:"";
                var p, f = e.get("link") || "";
                p = f ? '<a class="vnick" rel="nofollow" href="' + f + '" target="_blank" >' + e.get("nick") + "</a>"+spanm: '<span class="vnick">' + e.get("nick") + "</span>",
            ...
            P = function() {
                ...
                if (v.url = decodeURI(n), v.insertedAt = new Date, q.rid) {
                    ...
                    e.set("rid", q.rid),
                    e.set("pid", r),
                    v.comment = v.comment.replace("<p>", '<p><a class="at" href="#' + r + '">' + q.at + "</a> , ")
                }
            ...
            function(e) {
                var t = (e = event || e).keyCode || e.which || e.charCode; (e.ctrlKey || e.metaKey) && 13 === t && R(),
                9 === t && "veditor" == (document.activeElement.id || "") && (e.preventDefault(), E(f, "    "))
            })
        },
        e.exports = i,
        e.exports.
    ...
    function(e, t, n) {
        ...
        p = {
            ...
            on: function(e, t, n, r) {
                for (var i = 0,
                o = (e = e.split(" ")).length; i < o; i++) p.off(e[i], t, n, r),
                t.addEventListener ? t.addEventListener(e[i], n, r || !1) : t.attachEvent ? t.attachEvent("on" + e[i], n) : t["on" + e[i]] = n
            },
            off: function(e, t, n, r) {
                for (var i = 0,
                o = (e = e.split(" ")).length; i < o; i++) t.removeEventListener ? t.removeEventListener(e, n, r || !1) : t.detachEvent ? t.detachEvent("on" + e, n) : t["on" + e] = null
            },
            escape: function(e) {
            ...
            each: function(e, t) {
                ...
                r = e.length,
                i = {}.toString.call(e);
                if (["[object Array]", "[object NodeList]"].indexOf(i) > -1) for (; n < r && (!t || !1 !== t.call(e[n], n, e[n])); n++);
        ...
        function(i) {
            ...
            function m(e, t) {
                return function(e, t) {
                    ...
                    o = [],
                    a = [];
                    for (o[15] = a[15] = void 0, i.length > 16 && (i = u(i, 8 * e.length)), n = 0; n < 16; n += 1) o[n] = 909522486 ^ i[n],
                    a[n] = 1549556828 ^ i[n];
    ...
    function(e, t, n) { (function(t) { !
            function(t) {
                ...
                n.prototype.token = function(e, t) {
                    ...
                    this.tokens.push({
                        ...
                        for (e = e.substring(i[0].length), p = (o = i[2]).length > 1, this.tokens.push({
                            ...
                            ordered: p,
                            start: p ? +o: ""
                        }), n = !1, u = (i = i[0].match(this.rules.item)).length, c = 0; c < u; c++) l = (s = i[c]).length,
                ...
                r.prototype.output = function(e) {
                    ...
                    e = e.substring(a[0].length),
                    "@" === a[2] ? i = "mailto:" + (n = s(a[0])) : (n = s(a[0]), i = "www." === a[1] ? "http://" + n: n),
                    l += this.renderer.link(i, null, n);
                    return l
                },
    ...
    function(e, t) {
        function n(e) {
            return "<img id='emoji' src='https://cdn.jsdelivr.net/gh/zc998800/cdn/face/gif/" + e + ".gif'>"
        }
        function r(e) {
            return "<img id='emoji' src='https://cdn.jsdelivr.net/gh/zc998800/cdn/face/png/" + e + ".png'>"
        }
        var i;
        e.exports = {
            "b00": r("b00"),
